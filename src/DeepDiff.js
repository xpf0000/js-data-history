  ...
  if (change.path && change.path.length) {
    ...
    switch (change.kind) {
      case 'A':
        ...
        break
      case 'D':
        Vue && Vue.delete(it, change.path[i])
        delete it[change.path[i]]
        break
      case 'E':
      case 'N':
        Vue && Vue.set(it, change.path[i], change.rhs)
    ...
    switch (change.kind) {
      ...
      case 'E':
      case 'N':
        Vue && Vue.set(arr, index, change.rhs)
  ...
  if (target && change && change.kind) {
    ...
    while (++i < last) {
      if (typeof it[change.path[i]] === 'undefined') {
        ...
        Vue && Vue.set(it, change.path[i], d)
        it[change.path[i]] = d
      }
      it = it[change.path[i]]
    }
  ...
  if (change.path && change.path.length) {
    ...
    switch (change.kind) {
      case 'A':
        ...
        break
      case 'D':
        Vue && Vue.set(it, change.path[i], change.lhs)
    ...
    switch (change.kind) {
      case 'A':
        ...
        break
      case 'D':
        Vue && Vue.set(arr, index, change.lhs)
